// Version 1.3.0 icicle-chart - https://github.com/vasturiano/icicle-chart
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
  typeof define === 'function' && define.amd ? define(factory) :
  (global = global || self, global.Icicle = factory());
  ...
  var LABELS_HEIGHT_OPACITY_SCALE = linear$1().domain([15, 40]).clamp(true); // available height in px
  ...
  var icicle = index({
      ...
      _parseData: function _parseData(state) {
        if (state.data) {
          ...
          if (state.excludeRoot) {
            ...
            var yScale = linear$1().domain([hierData.y1 - hierData.y0, size[1]]).range([0, size[1]]);
    ...
    init: function init(domNode, state) {
      ...
      state.tooltip = d3Select('body').append('div').attr('class', 'chart-tooltip icicle-tooltip'); // tooltip cleanup on unmount
